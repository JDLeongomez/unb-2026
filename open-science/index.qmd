...
3.  **A Global Challenge**\
    Unequal access to reading and producing science, and where Brazil and Latin America stand..
...
### 2.0 How is scientific knowledge actually built? {auto-animate="true"}
...
### 2.0 What just happened? {auto-animate="true"}
...
**Q:** What percentage of published findings in psychology are statistically significant?\
**A:** [96%]{style="font-size: 150%;" .is-accent}
...
### 2.3 Ten threats, one root cause {auto-animate="true"}
...
### 2.4 P-hacking {auto-animate="true"}
...
### 2.6 The common thread {auto-animate="true"}
...
### 2.6 The four horsemen of the reproducibility apocalypse {auto-animate="true"}

![](img/4horsemen.jpg)

# Part 3: A Global Challenge {background-color="#2c3e50"}

------------------------------------------------------------------------

### 3.1 It's not just about *replicating* findings {auto-animate="true"}
...
### 3.2 Unequal access to knowledge {auto-animate="true"}
...
### 3.3 Unequal access to *producing* knowledge {auto-animate="true"}
...
### 3.4 Where does published science come from? {auto-animate="true"}
...
### 3.5 Two different bottlenecks {auto-animate="true"}
...
### 3.5 Two different bottlenecks {.center}
...
### 3.6 Not all Open Access is the same {auto-animate="true"}
...
### 3.7 Brazil: a regional leader {auto-animate="true"}
...
### 3.8 So what can we actually do about it? {auto-animate="true"}
