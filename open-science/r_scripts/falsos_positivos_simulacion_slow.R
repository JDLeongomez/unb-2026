...
n_estudios  <- 30   # Número de "estudios" (submuestras) a simular
n_muestra   <- 100    # Tamaño muestral por estudio (por submuestra)
fps_out     <- 2     # Cuadros por segundo del GIF resultante
...
# Guardar a disco ----
anim_save("simulacion_estudios_slow.gif", animation = anim)
